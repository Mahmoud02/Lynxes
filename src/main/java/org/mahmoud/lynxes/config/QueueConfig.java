...
import org.mahmoud.lynxes.core.FlushConfiguration;
import org.mahmoud.lynxes.core.FlushStrategy;

import java.nio.file.Path;
import java.nio.file.Paths;

/**
 * Configuration class for Lynxes message queue server.
...
public class QueueConfig {
    ...
    // Core settings
    @ConfigProperty("lynxes.storage.dataDirectory")
    private Path dataDirectory;
    
    @ConfigProperty("lynxes.storage.maxSegmentSize")
    private long maxSegmentSize;
    
    @ConfigProperty("lynxes.storage.retentionPeriodMs")
    private long retentionPeriodMs;
    
    @ConfigProperty("lynxes.storage.indexInterval")
    private int indexInterval;
    
    @ConfigProperty("lynxes.storage.maxMessageSize")
    private int maxMessageSize;
    
    // Server settings
    @ConfigProperty("lynxes.server.port")
    private int serverPort;
    
    @ConfigProperty("lynxes.server.threadPoolSize")
    private int threadPoolSize;
    
    @ConfigProperty("lynxes.performance.enableCompression")
    private boolean enableCompression;
    
    @ConfigProperty("lynxes.performance.enableMetrics")
    private boolean enableMetrics;
    
    // Performance settings
    @ConfigProperty("lynxes.performance.flushIntervalMs")
    private int flushIntervalMs;
    
    @ConfigProperty("lynxes.performance.maxConcurrentConnections")
    private int maxConcurrentConnections;
    
    @ConfigProperty("lynxes.performance.enableBatching")
    private boolean enableBatching;
    
    @ConfigProperty("lynxes.performance.batchSize")
    private int batchSize;
    
    // Flush strategy settings
    @ConfigProperty("lynxes.flush.strategy")
    private String flushStrategy;
    
    @ConfigProperty("lynxes.flush.messageInterval")
    private int flushMessageInterval;
    
    @ConfigProperty("lynxes.flush.timeIntervalMs")
    private int flushTimeIntervalMs;
    
    @ConfigProperty("lynxes.flush.forceMetadata")
    private boolean flushForceMetadata;
    
    @ConfigProperty("lynxes.flush.enablePageCache")
    private boolean flushEnablePageCache;
    
    // Logging settings
    @ConfigProperty("lynxes.logging.level")
    private String logLevel;
    
    @ConfigProperty("lynxes.logging.file")
