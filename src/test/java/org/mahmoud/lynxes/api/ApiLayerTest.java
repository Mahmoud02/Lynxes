...
public class ApiLayerTest {
    ...
    public void testTopic() throws IOException {
        ...
        try {
            ...
            // Note: getMessageCount() returns indexed records (sparse), not total records
            // With sparse interval 1000, only offset 0 gets indexed, so count should be 1
            assertTrue(topic.getMessageCount() >= 1); // At least 1 indexed record
    ...
    public void testProducer() throws IOException {
        ...
        try {
            ...
            assertTrue(producer.getMessageCount() >= 1); // At least 1 indexed record
    ...
    public void testConsumer() throws IOException {
        ...
        try {
            ...
            try {
                ...
                assertTrue(consumer.getMessageCount() >= 1); // At least 1 indexed record
